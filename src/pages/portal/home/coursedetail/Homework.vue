  ...
  <div class="list-wrapper">
    <el-card class="data-item" v-for="item in tableList" :key="item.id">
      ...
      <div>
        ...
        <el-button v-if="new Date(item.deadline).getTime() > new Date().getTime()" size="mini" @click="$router.push('/portal/home/course-detail/homework-detail?courseId=' + $route.query.courseId + '&homeworkId=' + item.id)" type="primary">查看详情
        </el-button>
